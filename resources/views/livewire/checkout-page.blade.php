        ...
        <div class="grid grid-cols-12 gap-4">
            <div class="md:col-span-12 lg:col-span-8 col-span-12">
                ...
                <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
                    ...
                    <ul class="@error('payment_method') border-red-500 @enderror grid w-full gap-6 md:grid-cols-2">
                        <li>
            ...
            <div class="md:col-span-12 lg:col-span-4 col-span-12">
                ...
                <button type="submit"
                    ...
                    <span wire:loading.remove>Order Items</span>
                            ...
                            <li class="py-3 sm:py-4" wire:key="{{$ci['product_id']}}">
                                <div class="flex items-center">
                                    ...
                                    <div
                                        ...
                                        {{Number::currency($ci['total_amount'],'XAF')}}
                                    </div>
                                </div>
                            </li>
                        @endforeach
